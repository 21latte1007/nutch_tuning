...
os.system('bin/nutch freegen ./urls/freegen.txt ./crawl/segments/')

print('Path memory')
folder_path = './crawl/segments/'
...
os.system('bin/nutch readseg -dump crawl/segments/{0} dump -nofetch -nogenerate -noparse -noparseText -nocontent'.format(sort[0]))
...
for outlinke, anchor in filtered_data:
...
os.system('bin/crawl -i -s urls/{0} crawl/1'.format(today))
...
os.system('bin/nutch readseg -dump crawl/segments/{0} -nofetch -nogenerate -noparse -noparsetext -noParsedata'.format(sort[0]))

shutil.rmtree('./crawl/crawldb')
shutil.rmtree('./crawl/linkdb')
